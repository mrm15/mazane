...
import officeman from "../../../../assets/icons/office-man.png";
...
const SingleCardView = ({row}) => {
  ...
  return (<div className={`px-2 rounded my-1  border-r-4 ${bg_basedStatus} `}
               style={{fontSize: 12}}
  >
    ...
    <ul className={"flex w-full justify-between"}>
      ...
      <li>
        <div
          ...
          className={"text-small"}>{row?.create_at}</div></li>
    </ul>
    {/*<ul className={"flex w-full justify-between"}>*/}
